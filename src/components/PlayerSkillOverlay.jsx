// components/PlayerSkillOverlay.jsx
import React from 'react';

export default function PlayerSkillOverlay({ skillData }) {
  if (!skillData) return null; // Si pas de sort actif, on n'affiche rien
      ...
      <style>{`
        .skill-overlay {
          ...
          animation: 
            ...
            skillFadeOut 0.4s ease forwards 2.6s; /* Disparaît visuellement avant que le parent le détruise */
        }
        .skill-portrait {
          width: 60px;
          height: 60px;
