// Pool de cartes du mode "Draft aux packs" — indépendant des autres modes.
// Chaque joueur pro existe en plusieurs éditions (rareté croissante), avec un
// rating différent par édition. Généré automatiquement, libre à toi d'éditer
// ou d'étoffer cette liste ensuite.

export const RARITIES = ['Commune', 'Rare', 'Épique', 'Légendaire'];
